...
public class LoginPage {
    ...
    public void verifyLoginSuccess(){
       // Assert.assertFalse(driver.getCurrentUrl().contains("login"), "FAIL. Vẫn còn ở trang Login");
        WebUI.assertNotContains(driver.getCurrentUrl(),"login" , "FAIL. Vẫn còn ở trang Login");
    }
    ...
    public void verifyLoginFail() {
        ...
        WebUI.assertEquals(driver.findElement(errorMessage).getText(), "Invalid login credentials", "Content of error massage NOT match.");
    }
